    ...
    <div className="about-container">
      ...
      <div className="content-container">
        ...
        <p className="intro-text">
          ...
          comfort, convenience, and satisfaction take flight alongside you. We are
          more than just a flight reservation system; we are your travel
          companion, committed to making every voyage unforgettable.
        </p>
        <h2 className="story-header">Our Story</h2>
        <p className="story-text">
          Born out of a passion for seamless travel and a commitment to redefining
          the way you explore the world, Bon Voyage is more than a platform; it's
          a vision. We started with a simple idea: to create a flight reservation
          system that mirrors the joy, excitement, and wonder of your journeys.
        </p>
      </div>
      </div>
      <div className="content-container">
